...
in_channels1 = {"resnet50": [64,256,512,2048,2048], "resnet18": 64}
kernel_size1 = {"resnet50": [64,64],  "resnet18": [64,64]}
stride2 = [16, 16]
in_channels2 = {"resnet50": 256, "resnet18": 64}
kernel_size2 = {"resnet50": [32,32],  "resnet18": [32,32]}
stride3 = [8, 8]
in_channels3 = {"resnet50": 512, "resnet18": 128}
kernel_size3 = {"resnet50": [16,16],  "resnet18": [16,16]}
stride4 = [2, 2]
in_channels4 = {"resnet50": 2048, "resnet18": 256}
kernel_size4 = {"resnet50": [5, 5], "resnet18": [8, 8]}
stride5 = [3, 3]
in_channels5 = {"resnet50": 2048, "resnet18": 512}
kernel_size5 = {"resnet50": [5, 5], "resnet18": [4, 4]}
...
if scale == 1:
    ...
    kernel_size = {"resnet50": [32,32],  "resnet18": [16,16]} #16,24,32,40,48,56
elif scale == 3:
    stride = [8, 8]
    in_channels = {"resnet50": 512, "resnet18": 128}
    kernel_size = {"resnet50": [6,6],  "resnet18": [28,28]}
elif scale == 4: 
    stride = [4, 4] 
    in_channels = {"resnet50": 1024, "resnet18": 256}
    kernel_size = {"resnet50": [8,8],  "resnet18": [10,10]}
else:
    stride = [2, 2]
    in_channels = {"resnet50": 2048, "resnet18": 512}
    kernel_size = {"resnet50": [5,5],  "resnet18": [7,7]}
...
Model_names = {'DTD': 'resnet18',
               'MINC_2500': 'resnetFresize_sizeFresize_size0',
...
Network_parameters = {'save_results': save_results,'folder': folder, 
                      ...
                      'stride1': stride1, 'stride2': stride2,   'stride3': stride3, 'stride4': stride4,'stride5': stride5,
                      'kernel_size1': kernel_size1,'kernel_size2': kernel_size2,'kernel_size3': kernel_size3,'kernel_size4': kernel_size4,'kernel_size5': kernel_size5,
                      'in_channels': in_channels,'in_channels1': in_channels1, 'out_channels': out_channels,
