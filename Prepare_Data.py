...
def Prepare_DataLoaders(Network_parameters, split,input_size=224):
    ...
    if Dataset=='DTD':
        ...
        train_dataset = MyDataset('labelDX_train.csv',img_transform=data_transforms['train'])
        test_dataset = MyDataset('labelDX_test.csv',img_transform=data_transforms['val'])
